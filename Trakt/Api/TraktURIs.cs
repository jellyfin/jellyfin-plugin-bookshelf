namespace Trakt.Api
{
    ...
    {
        public const string Devkey = "77449c38c9f4f9b3cdb8d3f9ef0566b167a935eb";
...
//        public const string WatchedShows = @"http://api.trakt.tv/user/library/shows/watched.json/" + Devkey + @"/{0}";
