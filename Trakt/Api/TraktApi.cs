...
//        {
//            var data = new Dictionary<string, string>
//                           {{"username", traktUser.UserName}, {"password", traktUser.Password}};
//
//            Stream response =
//                await
...
//        }
        ...
        /// <param name="traktUser"></param>
        /// <returns></returns>
        public async Task<List<TraktMovieWatched>> SendGetAllWatchedMoviesRequest(TraktUser traktUser)
        {
            var options = new HttpRequestOptions
            {
                Url = string.Format(TraktUris.WatchedMovies, traktUser.UserName),
                ResourcePool = Plugin.Instance.TraktResourcePool,
            ...
            return _jsonSerializer.DeserializeFromStream<List<TraktMovieWatched>>(response);
        }
        ...
        /// <param name="traktUser"></param>
        /// <returns></returns>
        public async Task<List<TraktShowWatched>> SendGetWatchedShowsRequest(TraktUser traktUser)
        {
            var options = new HttpRequestOptions
            {
                Url = string.Format(TraktUris.WatchedShows, traktUser.UserName),
                ResourcePool = Plugin.Instance.TraktResourcePool,
                CancellationToken = CancellationToken.None,
                RequestContentType = "application/json"
            };
            ...
            return _jsonSerializer.DeserializeFromStream<List<TraktShowWatched>>(response);
        }

        private static void SetRequestHeaders(HttpRequestOptions options)
        {
