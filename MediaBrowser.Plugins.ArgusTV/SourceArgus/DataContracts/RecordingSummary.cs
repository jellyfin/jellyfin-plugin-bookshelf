...
namespace ArgusTV.DataContracts
{
	...
	/// A recorded program.
	/// </summary>
	public partial class RecordingSummary : IProgramSummary
	{
        /// <summary>
        ...
        /// <summary>
        /// Is the recording actually available on disk (its file exists).
        /// </summary>
        [System.Xml.Serialization.XmlIgnore]
        ...
        public string ThumbnailFileName
        {
            get
            {
                return Recording.GetThumbnailFileName(this.RecordingFileName);
            }
        }
